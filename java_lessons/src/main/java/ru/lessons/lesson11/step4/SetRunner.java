...
public class SetRunner {
    public static void main(String[] args) {
        ...
        final var student1 = new Student(UUID.randomUUID(), "Ivan", 33, LocalDate.of(2000, 1, 2));
        final var student2 = new Student(UUID.randomUUID(), "John", 22, LocalDate.of(1980, 1, 2));
        final var student3 = new Student(UUID.randomUUID(), "Petr", 44, LocalDate.of(2001, 1, 2));
        final var students = new HashSet<>(List.of(student1, student2, student3));
        final var arr = students.toArray(Student[]::new);
        final var student1Copy = new Student(UUID.randomUUID(), "Ivan", 33, LocalDate.of(1960, 1, 2));
        ...
        Set<Student> studentsSet = new TreeSet<>(new StudentBirthDayComparator());
